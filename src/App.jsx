...
const EVENTS = [
  ...
  { time: "Jan 8–10", hour: "", phase: "PRELUDE", title: "Massacres Reported", desc: "Deadliest crackdowns kill thousands. Death toll estimates range from 3,117 (Iran gov't) to 32,000 (US estimate).", icon: "◉", source: "https://www.hrw.org/news/2026/01/16/iran-growing-evidence-of-countrywide-massacres" },
  ...
  { time: "Feb 3", hour: "", phase: "ESCALATION", title: "Strait of Hormuz Incident", desc: "Six IRGC gunboats attempt to seize US tanker Stena Imperative. USS McFaul escorts it to safety. US F-35 shoots down Iranian Shahed 139 drone approaching USS Abraham Lincoln.", icon: "◆", source: "https://www.cbsnews.com/news/us-tanker-stena-imperative-approached-iran-gunboats-strait-of-hormuz/" },
  ...
  { time: "Feb 17", hour: "", phase: "ESCALATION", title: "Khamenei Threatens US Fleet", desc: "During Geneva nuclear talks, Iran's Supreme Leader warns Iran is \"capable of\" striking American warships in the region.", icon: "◉", source: "https://www.aljazeera.com/news/2026/2/17/irans-khamenei-maintains-tough-rhetoric-with-us-despite-nuclear-talks" },
  ...
  { time: "Feb 26", hour: "", phase: "ESCALATION", title: "US Fleet Leaves Bahrain", desc: "Fleet HQ reduced to fewer than 100 personnel. All ships leave port. 14 refueling tankers deployed to Israel's Ben Gurion Airport. USS Gerald R. Ford positioned off Israel's coast.", icon: "◆", source: "https://www.middleeastmonitor.com/20260226-us-navy-withdraws-all-vessels-from-bahrain-base-amid-rising-tensions-with-iran/" },
  { time: "Feb 26", hour: "", phase: "ESCALATION", title: "\"Significant Progress\" in Talks", desc: "Third round of nuclear talks concludes in Geneva. Oman's mediator says significant progress made. More talks planned for next week.", icon: "◉", source: "https://foreignpolicy.com/2026/02/26/us-iran-nuclear-deal-geneva-talks-military-buildup-strikes/" },
  ...
  { time: "Feb 28", hour: "~4:00 AM ET", phase: "RETALIATION", title: "School Strike Reported", desc: "Iranian media reports Israeli strike hit a girls' elementary school in Minab, killing at least 40 students. Israel says it is investigating the reports.", icon: "◉", highlight: true, source: "https://www.aljazeera.com/news/2026/2/28/israel-strikes-two-schools-in-iran-killing-more-than-50-people" },
